...
export default function SearchCommand({ renderAs = 'button', label = 'Add stock', initialStocks }: SearchCommandProps) {
  ...
  return (
    ...
    />
      ...
      <CommandDialog open={open} onOpenChange={setOpen} className="bg-gray-800! lg:min-w-200 border-gray-600 fixed top-10 left-1/2 -translate-x-1/2 translate-y-10 z-50">
